...
export const MarketStatsCard: React.FC<MarketStatsCardProps> = ({ symbol }) => {
  const { data: coinData, loading } = useCoinData(symbol);
  ...
  const marketData = coinData.market_data as MarketData;
